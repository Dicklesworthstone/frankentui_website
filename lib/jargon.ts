...
const jargonMap: Record<string, JargonTerm> = {
  ...
  cell: {
    term: "Cell",
    short:
      "The smallest addressable unit on a terminal grid, holding one grapheme and its attributes.",
    ...
    analogy:
      "Think of a Cell like a single pixel on a screen, except instead of an RGB value it holds a character and its styling.",
  ...
  "cell-attrs": {
    term: "CellAttrs",
    short:
      "Style metadata attached to a Cell: colors, weight, decoration, and other SGR attributes.",
  ...
  buffer: {
    ...
    analogy:
      "Like a framebuffer in GPU rendering -- an off-screen image you draw into before presenting it.",
  ...
  presenter: {
    term: "Presenter",
    short:
      "The component that orchestrates rendering: diffs buffers, emits escape sequences, and flushes output.",
  ...
  "terminal-model": {
    ...
    analogy:
      "A flight simulator for terminals -- it behaves like the real thing but runs entirely in memory.",
  ...
  "front-buffer": {
    ...
    analogy:
      "The canvas that is currently facing the audience in a double-buffered painting setup.",
  ...
  scissor: {
    ...
    analogy:
      "Like the clipping mask in a graphics editor that hides everything outside a selected region.",
  ...
  grapheme: {
    ...
    analogy:
      "A grapheme is to Unicode what a letter is to the alphabet -- the thing you actually see, regardless of how many bytes make it up.",
  ...
  "grapheme-pool": {
    ...
    analogy:
      "Like a dictionary where every unique word gets a number, and from then on you just pass around the number.",
  ...
  "width-cache": {
    term: "Width Cache",
    short:
      "A memoization layer that caches the measured display width of text for a given constraint.",
  ...
  "terminal-capabilities": {
    ...
    short:
      "A detected feature set describing what the host terminal supports (colors, hyperlinks, sync, etc.).",
  ...
  "raw-mode": {
    term: "Raw Mode",
    short:
      "A terminal mode where input is delivered byte-by-byte with no line editing or signal handling.",
  ...
  ansi: {
    term: "ANSI",
    short:
      "The family of escape-sequence standards (ECMA-48 / ISO 6429) used to control terminal display.",
  ...
  csi: {
    term: "CSI",
    short:
      "Control Sequence Introducer (ESC [) -- the prefix for the most common terminal commands.",
  ...
  sgr: {
    term: "SGR",
    short:
      "Select Graphic Rendition (CSI ... m) -- the escape sequence for setting text style and color.",
  ...
  osc: {
    term: "OSC",
    short:
      "Operating System Command (ESC ]) -- escape sequences for out-of-band features like titles and hyperlinks.",
  ...
  dcs: {
    term: "DCS",
    short:
      "Device Control String (ESC P) -- escape sequences for device-level communication like Sixel graphics.",
  ...
  "dec-2026": {
    term: "DEC 2026",
    short:
      "Synchronized Output mode -- tells the terminal to batch updates and present them atomically.",
  ...
  sides: {
    term: "Sides",
    short:
      "A four-valued struct (top, right, bottom, left) representing padding, margin, or border widths.",
  ...
  flex: {
    term: "Flex",
    short:
      "A layout model that distributes space among children according to flexible weight factors.",
  ...
  "color-profile": {
    term: "ColorProfile",
    short:
      "The detected color depth of the terminal: monochrome, 16-color, 256-color, or true color.",
  ...
  "color-downgrade": {
    ...
    short:
      "The process of converting a true-color value to the nearest color in a smaller palette.",
  ...
  "style-flags": {
    term: "StyleFlags",
    short:
      "A bitfield encoding boolean text attributes: bold, italic, underline, strikethrough, etc.",
  ...
  model: {
    ...
    analogy:
      "Like the state object in Redux or the model in Elm -- a single immutable snapshot of everything the app knows.",
    related: ["program", "cmd", "subscription"],
  },
  cmd: {
    term: "Cmd",
    short:
      "A side-effect descriptor returned by the update function: async I/O, timers, quit signals, etc.",
    ...
    analogy:
      "Like an action creator in Redux-Saga or an Elm Cmd -- a description of a side effect, not the side effect itself.",
    related: ["program", "model", "subscription"],
  },
  subscription: {
    term: "Subscription",
    short:
      "A declarative subscription to an ongoing event source: keyboard input, timers, resize signals.",
  ...
  zwj: {
    term: "ZWJ",
    short:
      "Zero-Width Joiner (U+200D) -- an invisible character that fuses adjacent graphemes into one.",
  ...
  "combining-character": {
    ...
    short:
      "A Unicode character that modifies the preceding base character (accents, diacritics, etc.).",
  ...
  "display-width": {
    term: "Display Width",
    short:
      "The number of terminal columns a grapheme occupies: typically 1 (narrow) or 2 (wide/fullwidth).",
  ...
  "wtf-8": {
    term: "WTF-8",
    short:
      "A superset of UTF-8 that allows unpaired surrogates, used for lossless OS string round-tripping.",
  ...
  "source-over": {
    term: "Source Over",
    short:
      "The default Porter-Duff operator: draw the source on top of the destination, respecting alpha.",
  ...
  pty: {
    term: "PTY",
    short:
      "Pseudo-terminal -- an OS primitive that emulates a hardware terminal for programmatic I/O.",
  ...
  "property-test": {
    term: "Property Test",
    short:
      "A test that verifies invariants over randomly generated inputs (also called fuzzing or QuickCheck-style testing).",
  ...
  "terminal-model-test": {
    ...
    short:
      "An integration test that renders through the full pipeline into a TerminalModel and asserts on cell state.",
  ...
  mux: {
    term: "Mux",
    short:
      "Short for terminal multiplexer -- software that manages multiple terminal sessions in one window.",
  ...
  tmux: {
    term: "tmux",
    short:
      "A widely-used terminal multiplexer with its own escape-sequence passthrough mechanism (DCS tmux;).",
  ...
  screen: {
    term: "screen",
    short:
      "GNU Screen -- one of the oldest terminal multiplexers, with limited modern escape-sequence support.",
  ...
  zellij: {
    term: "zellij",
    short:
      "A modern terminal multiplexer written in Rust, with growing escape-sequence passthrough support.",
  ...
  sanitization: {
    term: "Sanitization",
    short:
      "Stripping or escaping dangerous control sequences from untrusted content before rendering.",
  ...
  "raw-passthrough": {
    ...
    short:
      "Injecting pre-formed escape sequences directly into the output stream, bypassing the diff engine.",
  ...
  raii: {
    term: "RAII",
    short:
      "Resource Acquisition Is Initialization -- a pattern ensuring cleanup happens automatically when a value is dropped.",
    ...
    analogy:
      "Like a self-closing door: no matter how you leave the room, the door always shuts behind you.",
  ...
  harness: {
    term: "Harness",
    short:
      "A runtime wrapper that connects the Kernel to a real terminal, event loop, and I/O layer.",
  ...
  "log-sink": {
    term: "LogSink",
    short:
      "A logging backend that captures diagnostic output without corrupting the terminal display.",
