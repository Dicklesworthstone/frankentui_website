...
export default function SiteHeader() {
  ...
  const { setTerminalOpen, toggleAnatomyMode, isAnatomyMode, isAudioEnabled, toggleAudio } =
    useSite();
      ...
      <div className="fixed top-0 left-0 right-0 z-50 hidden md:block pointer-events-none h-24">
        <header
          className={cn(
            ...
            scrolled
              ? "glass-modern shadow-2xl scale-[0.98] border-green-500/20"
          ...
          <div className="grid grid-cols-3 w-full relative z-10 h-full items-center">
            ...
            <div className="flex items-center justify-end gap-2 shrink-0">
              <button
                ...
                className="p-2 rounded-lg hover:bg-white/5 text-slate-400 hover:text-green-400 transition-colors"
              >
              ...
              <Magnetic strength={0.1}>
                <a
                  ...
                  className="px-5 py-2 rounded-full bg-white text-black text-[10px] font-black hover:bg-green-400 transition-all active:scale-95 uppercase tracking-widest"
                >
                  GITHUB
                </a>
              </Magnetic>
            ...
            >
              ...
              <div className="mt-auto space-y-4">
                ...
                <button
                  ...
                  className="w-full p-5 rounded-xl bg-white/5 border border-white/10 text-white font-black text-xs tracking-[0.2em]"
                >
                  SHELL_INTERFACE
                </button>
              </div>
