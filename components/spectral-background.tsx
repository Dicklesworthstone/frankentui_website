  ...
  return (
    <div className="fixed inset-0 z-[-5] pointer-events-none overflow-hidden select-none">
      ...
      <motion.div
        ...
        transition={
          prefersReducedMotion ? { duration: 0 } : { duration: 4, repeat: Infinity, ease: "linear" }
        }
      ...
      <div
        className="absolute bottom-0 right-1/4 w-[40%] h-[40%] bg-blue-500/5 blur-[100px] rounded-full animate-pulse"
