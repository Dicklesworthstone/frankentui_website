  ...
  return (
    ...
    >
      <FrankenContainer
        ...
        className="group h-full glass-modern transition-all duration-500 hover:bg-white/[0.03] border-white/5 group-hover:border-white/10"
      >
        <div className="flex h-full flex-col p-8">
          <div className="mb-8 flex items-center justify-between">
            ...
            <motion.div whileHover={{ rotate: 180 }} transition={{ duration: 0.5 }}>
              <Binary
                className="h-4 w-4 text-slate-700 transition-colors"
          ...
          {algorithm.formula && (
            <div className="relative group/code mt-auto">
              <div
                className="absolute -inset-2 rounded-lg opacity-0 group-hover/code:opacity-100 transition-opacity"
                style={{ backgroundColor: `${accentColor}05` }}
              />
              <div
                className="relative font-mono text-[11px] font-bold transition-colors overflow-hidden"
