...
export const frankentermweb_apiContract: (a: number) => number;
...
export const frankentermweb_markersState: (a: number) => number;
...
export const frankentermweb_rendererBackend: (a: number, b: number) => void;
...
export const frankentermweb_scrollLines: (a: number, b: number) => number;
export const frankentermweb_scrollPages: (a: number, b: number) => number;
export const frankentermweb_scrollToBottom: (a: number) => number;
export const frankentermweb_scrollToLine: (a: number, b: number) => number;
export const frankentermweb_scrollToTop: (a: number) => number;
...
export const frankentermweb_setClipboardPolicy: (a: number, b: number, c: number) => void;
...
export const __wasm_bindgen_func_elem_3005: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_3007: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_1604: (a: number, b: number, c: number) => void;
