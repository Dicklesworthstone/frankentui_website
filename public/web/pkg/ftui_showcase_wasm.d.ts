...
export class ShowcaseRunner {
   ...
   */
  paneTouchPointerDownAt(
    pointer_id: number,
    x: number,
    y: number,
    active_touch_points: number,
    mods: number,
  ): any;
  /**
...
export interface InitOutput {
  ...
  readonly showcaserunner_panePointerDown: (
    a: number,
    b: bigint,
    c: number,
    d: number,
  ...
  readonly showcaserunner_panePointerDownAt: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly showcaserunner_panePointerMove: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly showcaserunner_panePointerMoveAt: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly showcaserunner_panePointerUp: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly showcaserunner_panePointerUpAt: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly showcaserunner_paneSetExecutionPolicy: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly showcaserunner_paneTouchPointerDownAt: (
    a: number,
    b: number,
    c: number,
    d: number,
