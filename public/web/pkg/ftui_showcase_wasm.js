...
export class ShowcaseRunner {
  ...
  panePointerDownAt(pointer_id, button, x, y, mods) {
    const ret = wasm.showcaserunner_panePointerDownAt(
      this.__wbg_ptr,
      pointer_id,
      button,
      x,
  ...
  panePointerDown(split_id, axis, pointer_id, button, x, y, mods) {
    const ret = wasm.showcaserunner_panePointerDown(
      this.__wbg_ptr,
      split_id,
      axis,
      pointer_id,
  ...
  paneSetExecutionPolicy(mode, max_retained_bytes, max_retained_edits) {
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.showcaserunner_paneSetExecutionPolicy(
        retptr,
        this.__wbg_ptr,
        addHeapObject(mode),
        addHeapObject(max_retained_bytes),
        addHeapObject(max_retained_edits),
      );
      var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
      var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
      if (r1) {
  ...
  paneTouchPointerDownAt(pointer_id, x, y, active_touch_points, mods) {
    const ret = wasm.showcaserunner_paneTouchPointerDownAt(
      this.__wbg_ptr,
      pointer_id,
      x,
      y,
...
function __wbg_get_imports() {
  const import0 = {
    ...
    __wbg_new_from_slice_a500ec81601be48f: (arg0, arg1) => {
      const ret = new Uint32Array(getArrayU32FromWasm0(arg0, arg1));
      return addHeapObject(ret);
    },
    __wbg_now_d1fb6650485d7f3e: () => {
      const ret = Date.now();
      return ret;
    },
    ...
    __wbindgen_generic_0000000000000001: (arg0) => {
...
const ShowcaseRunnerFinalization =
