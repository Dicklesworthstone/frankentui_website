...
export class FrankenTermWeb {
    ...
    attachTransportClosed(code, clean, reason, now_ms) {
        const ptr0 = passStringToWasm0(reason, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.frankentermweb_attachTransportClosed(this.__wbg_ptr, code, clean, ptr0, len0, now_ms);
        return takeObject(ret);
    }
    /**
    ...
    createDecoration(kind, start_marker_id, end_marker_id, start_col, end_col) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.frankentermweb_createDecoration(retptr, this.__wbg_ptr, ptr0, len0, start_marker_id, end_marker_id, start_col, end_col);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    createEventSubscription(options) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.frankentermweb_createEventSubscription(retptr, this.__wbg_ptr, isLikeNone(options) ? 0 : addHeapObject(options));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    drainEventSubscriptionJsonl(subscription_id, run_id, seed, timestamp) {
        try {
            ...
            wasm.frankentermweb_drainEventSubscriptionJsonl(retptr, this.__wbg_ptr, subscription_id, ptr0, len0, seed, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    drainImeCompositionJsonl(run_id, seed, timestamp) {
        ...
        const ptr1 = passStringToWasm0(timestamp, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.frankentermweb_drainImeCompositionJsonl(this.__wbg_ptr, ptr0, len0, seed, ptr1, len1);
        return takeObject(ret);
    }
    /**
    ...
    drainMarkerDecorationJsonl(run_id, seed, timestamp) {
        try {
            ...
            const ptr1 = passStringToWasm0(timestamp, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len1 = WASM_VECTOR_LEN;
            wasm.frankentermweb_drainMarkerDecorationJsonl(retptr, this.__wbg_ptr, ptr0, len0, seed, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    snapshotScrollbackFrameJsonl(run_id, timestamp, frame_idx, render_cost_us) {
        ...
        try {
            ...
            const ptr1 = passStringToWasm0(timestamp, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len1 = WASM_VECTOR_LEN;
            wasm.frankentermweb_snapshotScrollbackFrameJsonl(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1, frame_idx, render_cost_us);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_getImageData_84189b35c8573758: function() { return handleError(function (arg0, arg1, arg2, arg3, arg4) {
        ...
        __wbg_set_imageSmoothingEnabled_0c6c182cfcdfe8d2: function(arg0, arg1) {
