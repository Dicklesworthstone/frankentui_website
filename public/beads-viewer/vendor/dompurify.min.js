...
!((e, t) => {
  ...
  function b(e, o) {
    const r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : p;
    t && t(e, null);
    let i = o.length;
    for (; i--; ) {
      let t = o[i];
  ...
  function R(e, t) {
    ...
    return (e) => (console.warn("fallback value for", e), null);
  }
  const w = i([
      "a",
      "abbr",
  ...
  var V = (function t() {
    const n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : X();
    const o = (e) => t(e);
    ...
    let ae = {};
    o.isSupported =
      "function" == typeof e && "function" == typeof J && te && void 0 !== te.createHTMLDocument;
    const {
      MUSTACHE_EXPR: le,
      ERB_EXPR: ce,
      TMPLIT_EXPR: se,
    ...
    const ot = r.createElement("form"),
      rt = (e) => e instanceof RegExp || e instanceof Function,
      it = function () {
    ...
    const mt = (e) => {
      ...
      ht = (e) =>
        ne.call(e.ownerDocument || e, e, F.SHOW_ELEMENT | F.SHOW_COMMENT | F.SHOW_TEXT, null),
      gt = (e) =>
        e instanceof z &&
      ...
      Tt = (e) => "function" == typeof N && e instanceof N,
      yt = (e, t, n) => {
        ae[e] &&
          u(ae[e], (e) => {
            e.call(o, t, n, nt);
