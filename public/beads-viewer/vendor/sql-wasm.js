  ...
  initSqlJsPromise = new Promise((resolveModule, reject) => {
    ...
    f.onRuntimeInitialized = () => {
        ...
        switch (typeof l) {
          ...
          case "object":
            if (null === l) lb(g);
              ...
              Aa(g, "Wrong API use : tried to return a value of an unknown type (" + l + ").", -1);
            break;
          default:
            lb(g);
        }
      ...
      var h = x(4),
        ...
        H = k("sqlite3_prepare_v2", "number", ["number", "string", "number", "number", "number"]),
        pb = k("sqlite3_sql", "string", ["number"]),
        vc = k("sqlite3_normalized_sql", "string", ["number"]),
        qb = k("sqlite3_prepare_v2", "number", ["number", "number", "number", "number", "number"]),
        wc = k("sqlite3_bind_text", "number", ["number", "number", "number", "number", "number"]),
        rb = k("sqlite3_bind_blob", "number", ["number", "number", "number", "number", "number"]),
        ...
        oc = k("sqlite3_result_text", "", ["number", "string", "number", "number"]),
        pc = k("sqlite3_result_blob", "", ["number", "number", "number", "number"]),
      ...
      c.prototype.bind = function (g) {
        ...
        this.reset();
        return Array.isArray(g) ? this.wb(g) : null != g && "object" === typeof g ? this.xb(g) : !0;
      };
      ...
      c.prototype.get = function (g, l) {
        ...
        g = [];
        for (var n = Dc(this.La), t = 0; t < n; t += 1)
          switch (Hc(this.La, t)) {
            case 1: {
          ...
          for (g = []; 0 !== m(z, "i8"); ) {
            ...
            if (0 !== L) {
              ...
              for (null != l && w.bind(l); w.step(); )
                null === K && ((K = { columns: w.getColumnNames(), values: [] }), g.push(K)),
      ...
      e.prototype.create_function = function (g, l) {
        Object.hasOwn(this.Na, g) && (ua(this.Na[g]), delete this.Na[g]);
        var n = xa((t, w, z) => {
          w = b(w, z);
          try {
      ...
      e.prototype.create_aggregate = function (g, l) {
        ...
        Object.hasOwn(this.Na, g) && (ua(this.Na[g]), delete this.Na[g]);
        l = g + "__finalize";
        Object.hasOwn(this.Na, l) && (ua(this.Na[l]), delete this.Na[l]);
        var N = xa((K, O, Ua) => {
            var X = ub(K, 1);
            Object.hasOwn(z, X) || (z[X] = n());
            O = b(O, Ua);
            O = [z[X]].concat(O);
            try {
              z[X] = w.apply(null, O);
    ...
    var fb = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0,
      M = (a, b, c) => {
        var d = b + c;
        for (c = b; a[c] && !(c >= d); ) ++c;
      ...
      for (var c = Hb, d = "/", e = 0; e < a.length; e++) {
        ...
        if (!h || b.Sa)
          for (h = 0; 40960 === (c.mode & 61440); )
            if (((c = Mb(d)), (d = mb(hb(d), c)), (c = T(d, { kb: b.kb + 1 }).node), 40 < h++))
              throw new P(32);
      }
    ...
    var Pc = (a, b) => ((b + 2097152) >>> 0 < 4194305 - !!a ? (a >>> 0) + 4294967296 * b : NaN),
      ...
      xa = (a, b) => {
        ...
        try {
          ...
          if ("function" == typeof WebAssembly.Function) {
            ...
            for (
              var h = { parameters: [], results: "v" == b[0] ? [] : [e[b[0]]] }, k = 1;
              k < b.length;
              ++k
            )
    ...
    var $c = {
        ...
        g: (a) => {
          try {
            var b = U(a).node;
            var c = "string" == typeof b ? T(b, { Sa: !0 }).node : b;
        ...
        r: (a, b, c) => {
          try {
            return (
              (b = b ? M(q, b) : ""),
              (b = kc(a, b)),
              0 === c ? wa(b) : 512 === c ? $b(b) : C("Invalid flags passed to unlinkat"),
              0
            );
          } catch (d) {
            if ("undefined" == typeof W || "ErrnoError" !== d.name) throw d;
        ...
        q: (a, b, c) => {
          try {
            ...
            b = kc(a, b, !0);
            if (c) {
              var d = E[c >> 2] + 4294967296 * D[(c + 4) >> 2],
                e = D[(c + 8) >> 2];
              h = 1e3 * d + e / 1e6;
              c += 16;
        ...
        l: (a, b, c) => {
          ...
          b = a.getFullYear();
          D[(c + 28) >> 2] =
            ((0 !== b % 4 || (0 === b % 100 && 0 !== b % 400) ? Rc : Qc)[a.getMonth()] +
              a.getDate() -
              1) |
            0;
      ...
      Z = (() => {
        function a(c) {
          ...
          0 == G &&
            (null !== Wa && (clearInterval(Wa), (Wa = null)), Xa && ((c = Xa), (Xa = null), c()));
          return Z;
        }
        var b = { a: $c };
        G++;
    ...
    function cd() {
      ...
      if (!(0 < G)) {
        if (f.preRun)
          for ("function" == typeof f.preRun && (f.preRun = [f.preRun]); f.preRun.length; ) Va();
        eb(Ra);
        0 < G ||
          (f.setStatus
            ? (f.setStatus("Running..."),
