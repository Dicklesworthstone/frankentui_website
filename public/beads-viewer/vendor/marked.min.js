...
!((e, t) => {
  ...
  class x {
    ...
    inlineText(e) {
      ...
      if (t) {
        let e;
        return (
          (e = this.lexer.state.inRawBlock ? t[0] : c(t[0])), { type: "text", raw: t[0], text: e }
        );
      }
    }
  }
  const b = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,
    ...
    K = {
      ...
      url: p(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9-]+\.?)+[^\s<]*|^email/, "i")
        .replace(
          "email",
  ...
  (oe.options = oe.setOptions =
    (e) => (le.setOptions(e), (oe.defaults = le.defaults), n(oe.defaults), oe)),
    (oe.getDefaults = t),
    (oe.defaults = e.defaults),
    (oe.use = (...e) => (le.use(...e), (oe.defaults = le.defaults), n(oe.defaults), oe)),
    (oe.walkTokens = (e, t) => le.walkTokens(e, t)),
